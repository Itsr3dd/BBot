...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if result:
        ...
        message = (
            ...
            "If you ever lose connection to GitHub or your token expires, just use **/github** to reconnect feel free to contact us for feedback and support.\n\n"
            "I’m here to help you land your next 10x and make your Github life easier. Let’s get started! 🚀"
        )
...
async def clear(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = "All your tracked repositories have been cleared."
    await update.message.reply_text(message)
